...
\begin{titlebox}
  ...
  \begin{showinfo}
    ...
    \generic{\faGithubAlt}{ \href{https://tsikup.github.io}{tsikup.github.io} }
  \end{showinfo}
...
\begin{describesection}
  ...
  \leftside{1.}
  \rightsideplain{C. Spanakis, E. Mathioudakis, N. Kampanis, N. Tsiknakis, K. Marias, Renyi divergence and non-deterministic subsampling in Rigid Image Registration, 2019 IEEE International Conference on Imaging Systems and Techniques (IST) (submitted)}
